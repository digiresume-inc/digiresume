...
import { FaUserAlt, FaLanguage, FaQuoteLeft, FaQuoteRight } from 'react-icons/fa';
      ...
      <div className="grid-single-grid-top relative">
        ...
        >
          ...
          >
            ...
            >
              <FaUserAlt size={15} className="text-primary" aria-hidden="true" />
              <span className="text-foreground/70 font-semibold text-sm">About</span>
            </Link>
            <Link
              href="#works"
              ...
              className={`col-span-1 rounded-lg bg-secondary flex gap-1 items-center justify-center`}
            >
              <LuConstruction size={15} className="text-primary" aria-hidden="true" />
              <span className="text-foreground/70 font-semibold text-sm">Works</span>
            </Link>
            <Link
              href="#contact"
            ...
            >
              ...
              <span className="text-foreground/70 font-semibold text-sm">Contact</span>
            </Link>
          </Block>
        </div>
        <div className="grid-single-first" role="region" aria-labelledby="tech-stack-and-timeline">
          <div className="grid grid-rows-8 gap-3 w-full h-full">
            ...
            >
              <span id="tech-stack-heading" className="flex items-center mb-1">
                <TbStack2Filled className="text-primary mr-1" size={20} aria-hidden="true" />
                <p className="text-foreground/60 text-sm font-semibold">My Stack</p>
              </span>
              ...
              >
                {additionalinfo.techstack.slice(0, 6).map((skill: any, index: number) => (
                  <span
                    key={index}
            ...
            >
              ...
              <div className="absolute h-1/5 w-full bg-background border-b border-primary/30 z-10 top-0 left-0 flex items-center justify-center">
                <MdViewTimeline className="text-primary mr-1" size={20} aria-hidden="true" />
                <p id="timeline-heading" className="text-foreground/80 text-base font-bold">
                  My Timeline
                </p>
              </div>
        ...
        <div role="region" aria-labelledby="main-profile" className="grid-single-second">
            ...
            >
              <div id="about" className="flex flex-col p-4 gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="h-[100px] w-full p-2">
                    <div className="flex items-center justify-between">
                      ...
                      {profile.profile_link?.url?.trim() && profile.profile_link?.text?.trim() && (
                        <a
                  ...
                  {[
                    {
                      ...
                      label: profile.country ? profile.country.split('-')[0] : 'Nomad',
                    },
                    {
                    ...
                    >
                      {item.icon}
                      <p className="text-foreground/60 text-xs font-semibold">{item.label}</p>
                    </div>
                  ))}
                  <a
                ...
                >
                  ...
                  <p className="italic leading-snug px-2 text-foreground">{additionalinfo.quote}</p>
        ...
        <div role="region" aria-labelledby="certifications-contact" className="grid-single-third">
          <div id="works" className="grid grid-rows-15 grid-cols-7 gap-3 w-full h-full">
            <Block
              delay={1.3}
            ...
            >
              ...
              <span className="flex items-center mb-1">
                ...
                <p className="text-foreground/60 text-sm font-semibold">Certs</p>
              </span>
              <p className="text-foreground/80 font-bold mb-4">My Certifications</p>
              <div className="flex flex-col gap-3 items-center justify-center w-full px-4">
                {profile.certifications.slice(0, 4).map((cert: any, index: number) => (
                  <a
                    key={index}
                    href={cert.url}
                    target="_blank"
            ...
            >
              ...
              <p className="text-foreground/80 font-bold text-xl mb-1">Work Together</p>
