...
const ShareCard = ({ profile }: { profile: any }) => {
  const [modal, setModal] = useState(false);
  return (
    <>
      <Button
        className="absolute top-0 lg:top-4 right-4 lg:right-24"
        variant={'outline'}
        size={'icon'}
      ...
      >
        <div
          ...
          className="relative z-50 w-full border bg-muted data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95  rounded-lg md:w-full bg-dash-sidebar sm:align-middle sm:w-full sm:max-w-sm p-0 gap-0 pb-5 !block"
          // style={{
          //   pointerEvents: 'auto',
