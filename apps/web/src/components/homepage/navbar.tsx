...
const Navbar = () => {
  ...
  const NavLogos = ['/logos/text_dark.png', '/logos/text_light.png'];
    ...
    <>
      ...
      <nav className="fixed top-0 left-0 z-[1000] w-full pt-5 px-5 lg:px-0">
        ...
        >
          ...
          <Link
            href="/signin"
            className="flex items-center gap-1 px-2 py-1 text-xs lg:px-3 lg:py-1.5 lg:text-sm bg-foreground/10 backdrop-blur-md border border-foreground/20 hover:border-foreground/40 transition-all text-foreground rounded-full"
          >
            Sign in
          </Link>
        </div>
